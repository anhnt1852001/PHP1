...
<body>
    ...
    <div class="container-fluid">
        ...
        <div class="box1">
            ...
            <a href="./chitet.php"><h6 >HEYYOU MEOW TEE </h6></a><p>189,000₫ </p>
            
          
        </div>
        <div class="box1">
            <img src="img/ao10.JPG" alt="">
            <a href="./chitet.php"><h6>RAINBOW ESSENTIAL TEE </h6></a><p> 114,000₫ </p>
          
            <div style="clear: both;"></div>
        </div>
        <div class="box1">
            <img src="img/ao2.jfif" alt="">
            <a href="./chitet.php"><h6>ROLLING LINE TEE </h6></a><p> 114,000₫</p>
