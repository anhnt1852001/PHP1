            ...
            <tbody>
                <tr>
                    ...
                    <td>
                        ...
                        <a href="Quantri/Danhmuc.php"><button type="button" class="btn btn-outline-info">Danh Mục</button></a>
                        <a href="Quantri/product.php"><button type="button" class="btn btn-outline-info">Sản Phẩm</button></a>
                    </td>
                </tr>
            </tbody>
        </table>
