...
<body>
    <div class="container">
        <div class="dm">
            <a href="../trangchu.php"><button type="button" class="btn btn-outline-primary">Trang chủ</button></a>
            ...
            <tbody>
                ...
                foreach ($result as $c) : ?>
                    <tr>
                        ...
                        <td><?= $c['cate_name'] ?></td>
                        <td>
                            <a href="them_cate.php"><button type="button" class="btn btn-outline-danger">Thêm Danh Mục</button></a> |
                            <a href="sua_cate.php?id=<?= $c['cate_id'] ?>"><button type="button" class="btn btn-outline-danger">Sửa</button></a> |
                            <a onclick="return confirm('Bạn có chắc chắn xóa không')" href="xoa_cate.php?id=<?= $c['cate_id'] ?>"><button type="button" class="btn btn-outline-danger">xóa</button></a> |
