    ...
    <nav class="navbar navbar-expand-lg navbar-light">
        ...
        <a class="navbar-brand" href="./trangchu.html">
            <img src="img/logo_heyyou_website-04_cfe6eb8b64f7430db789de966b4003b3-removebg-preview.png"
                class="d-inline-block align-top" width="90" height="80" alt="...">
        </a>
        ...
        <div class="collapse navbar-collapse" id="idCollapse">
            <ul class="navbar-nav mr-auto">`
                <li class="nav-item">
                    <a class="nav-link" href="./trangchu.html">Trang chủ<h6 class="sr-only">(current)</h6></a>
                </li>
    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-lg-2">
                ...
                <h6>HEYYOU MEOW TEE</h6>
                <p> 189,000₫ </p>
                <!-- <button>Mua</button> -->
                <a href="#" class="btn btn-secondary">Mua</a>
                <i class="fas fa-shopping-cart"></i>
            </div>
            <div class="col-lg-2">
                <img src="img/ao10.JPG" alt="">
                <h6> RAINBOW ESSENTIAL TEE</h6>
                <p> 114,000₫ </p>
                <a href="#" class="btn btn-secondary">Mua</a>
                <i class="fas fa-shopping-cart"></i>
            </div>
            <div class="col-lg-2">
                <img src="img/ao9.webp" alt="">
                <h6> BASIC SKETCH</h6>
                <p> 114,000₫ </p>
                <a href="#" class="btn btn-secondary">Mua</a>
                <i class="fas fa-shopping-cart"></i>
        ...
        <div class="row">
            <div class="col-lg-2">
                <img src="img/ao12.png" alt="">
                <h6>BLACK HYU VARSITY</h6>
                <p>496,000₫</p>
                <a href="#" class="btn btn-secondary">Mua</a>
                <i class="fas fa-shopping-cart"></i>
            </div>
            <div class="col-lg-2">
                <img src="img/ao13.png" alt="">
                <h6>HEYYOUSTUDIO ZIPPER JACKET</h6>
                <p> 214,000₫ </p>
                <a href="#" class="btn btn-secondary">Mua</a>
                <i class="fas fa-shopping-cart"></i>
            </div>
            <div class="col-lg-2">
                <img src="img/ao14.png" alt="">
                <h6>HEYYOU ESSENTIAL COLLECTIONS</h6>
                <p> 99,000₫</p>
                <a href="#" class="btn btn-secondary">Mua</a>
                <i class="fas fa-shopping-cart"></i>
            </div>
            <div class="col-lg-2">
                <img src="img/ao15.png" alt="">
                <h6>Áo thun BE HAPPY TEE</h6>
                <p> 114,000₫ </p>
                <a href="#" class="btn btn-secondary">Mua</a>
                <i class="fas fa-shopping-cart"></i>
            </div>
