...
if (isset($_POST['btnLuu'])) {
    ...
    if (!array_filter($errors)) {
        $sql = "UPDATE products SET product_name='$product_name',brand_id = '$brand_id',price = '$price',image='$image',description='$description'
    ...
    <form action="" method="POST" enctype="multipart/form-data">
        ...
        <select name="brand_id" id="">
            <?php foreach ($brand as $c) : ?>
                <?php if ($c['brand_id'] == $result['brand_id']) : ?>
                    <option value="<?= $c['brand_id'] ?>" selected><?= $c['brand_name'] ?></option>
                <?php else : ?>
